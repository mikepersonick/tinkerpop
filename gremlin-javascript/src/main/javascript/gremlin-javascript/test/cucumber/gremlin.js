...
const gremlins = {
    ...
    Inject_null_eqXnullX: [function({g}) { return g.inject(null).is(P.eq(null)) }], 
    Inject_NaN_eqXNaNX: [function({g, xx1}) { return g.inject(xx1).is(P.eq(Number.NaN)) }], 
    Inject_NaN_neqXNaNX: [function({g, xx1}) { return g.inject(xx1).is(P.neq(Number.NaN)) }], 
    Inject_Inf_eqXInfX: [function({g, xx1}) { return g.inject(xx1).is(P.eq(Number.POSITIVE_INFINITY)) }], 
    Inject_Inf_neqXInfX: [function({g, xx1}) { return g.inject(xx1).is(P.neq(Number.POSITIVE_INFINITY)) }], 
    Inject_NegInf_eqXNegInfX: [function({g, xx1}) { return g.inject(xx1).is(P.eq(Number.NEGATIVE_INFINITY)) }], 
    Inject_NegInf_neqXNegInfX: [function({g, xx1}) { return g.inject(xx1).is(P.neq(Number.NEGATIVE_INFINITY)) }], 
