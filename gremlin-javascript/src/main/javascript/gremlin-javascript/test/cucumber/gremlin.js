...
const gremlins = {
    ...
    g_V_properties__properties_element_element: [function({g}) { return g.addV().property("name","MetaPropertyTest").properties("name").property("c","d") }, function({g}) { return g.V().properties().properties().element().element() }], 
