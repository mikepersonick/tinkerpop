...
world.gremlins = {
    ...
    'g_V_properties__properties_element_element': [(lambda g:g.addV().property('name','MetaPropertyTest').properties('name').property('c','d')), (lambda g:g.V().properties().properties().element().element())], 
