...
world.gremlins = {
    ...
    'Inject_null_eqXnullX': [(lambda g:g.inject(None).is_(P.eq(None)))], 
    'Inject_NaN_eqXNaNX': [(lambda g, xx1=None:g.inject(xx1).is_(P.eq(float('nan'))))], 
    'Inject_NaN_neqXNaNX': [(lambda g, xx1=None:g.inject(xx1).is_(P.neq(float('nan'))))], 
    'Inject_Inf_eqXInfX': [(lambda g, xx1=None:g.inject(xx1).is_(P.eq(float('inf'))))], 
    'Inject_Inf_neqXInfX': [(lambda g, xx1=None:g.inject(xx1).is_(P.neq(float('inf'))))], 
    'Inject_NegInf_eqXNegInfX': [(lambda g, xx1=None:g.inject(xx1).is_(P.eq(float('-inf'))))], 
    'Inject_NegInf_neqXNegInfX': [(lambda g, xx1=None:g.inject(xx1).is_(P.neq(float('-inf'))))], 
